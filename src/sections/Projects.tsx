      ...
      <div className="container lg:max-w-5xl">
        ...
        <div className="flex flex-col mt-10 gap-16 md:mt-20">
          {portfolioProjects.map((project) => (
            <div
              key={project.title}
              className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 py-8 after:pointer-events-none md:pt-12 md:px-10 lg:pt-16 lg:px-20"
            >
              <div
                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                    {project.results.map((result) => (
                      ...
                      >
                        <CheckIconCircular className="size-5 md:size-6" />
                        <span>{result.title}</span>
                      </li>
                    ))}
                  </ul>
                  <a href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full  px-4 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8 transition-all duration-400 hover:animate-pulse-white ">
                ...
                <div>
                  <div className="overflow-hidden z-0 rounded-lg">
                    <Image
                      src={project.image}
                      alt={project.title}
                      className="mt-8 -mb-8 rounded-lg align-center md:-mb-0 lg:mt-0  "
                    />
                  </div>
                </div>
              </div>
