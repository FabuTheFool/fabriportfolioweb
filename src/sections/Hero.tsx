    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="relative container z-50">
        ...
        <div className="flex flex-col items-center mt-8  gap-4 md:flex-row justify-center">
          <a
            href="#projects"
            className="boton1 inline-flex items-center gap-2 bg-gray-900/20 border border-white/15 px-6 h-12 rounded-xl backdrop-blur group"
          >
            <span className="font-semibold">Mi trabajo</span>
            <ArrowDown className="size-4 group-hover:animate-pulse" />
          </a>
          <a
            href="https://api.whatsapp.com/send?phone=595981400359"
            className="boton2 inline-flex items-center gap-2 border-white text bg-white text-gray-900 h-12 px-6 border rounded-xl shadow-sm !animate-pulse-white"
          >
            <span className="">👋</span>
